...
def read_file(source_dataset,dataset, seed=1):
    dir = "/shared/s2/lab01/myungjoo/RPO_v2/output/rpo_prime/dg"
    dir += '/test_target'

    dir += f"/source_imagenet/{dataset}/seed{seed}"
...
source_list = "imagenet imagenet_a imagenet_r imagenet_sketch imagenetv2".split()
...
for source_dataset in source_list:
    ...
    for dataset in source_list:
        ...
        df.to_csv(f'./transfer_csv_rpoprime_dg/source_imagenet_weightinfer.csv')
